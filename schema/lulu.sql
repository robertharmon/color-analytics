...
\restrict gsk0tLRnXvPIaJCYGtQgypoACdqaQLGA4A4pkage7v9feNEd8EInZsLcFpTcuA1
...
CREATE TABLE public.appendix (
    ...
    default_sku character varying(50),
    default_parent_category character varying(50),
    product_on_sale integer,
    is_colorway boolean
);
...
\unrestrict gsk0tLRnXvPIaJCYGtQgypoACdqaQLGA4A4pkage7v9feNEd8EInZsLcFpTcuA1
