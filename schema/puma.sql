...
\restrict Po9vOxybINLW2Z3WmQ1ntS73vkigcHg3zrNHQwS1hsf9azraNFoMdgxZB3LLsv3
...
CREATE TABLE public.appendix (
    ...
    master_id character varying(50),
...
CREATE TABLE public.instance (
    ...
    title_second character varying(200),
    price_std integer,
    price_curr integer,
...
--
-- Name: instance fk_archive_id_ref; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.instance
    ADD CONSTRAINT fk_archive_id_ref FOREIGN KEY (archive_id_ref) REFERENCES public.archive(archive_id);
...
--
-- Name: staging_instance fk_staging_archive_id_ref; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.staging_instance
    ADD CONSTRAINT fk_staging_archive_id_ref FOREIGN KEY (archive_id_ref) REFERENCES public.staging_archive(archive_id);
...
\unrestrict Po9vOxybINLW2Z3WmQ1ntS73vkigcHg3zrNHQwS1hsf9azraNFoMdgxZB3LLsv3
